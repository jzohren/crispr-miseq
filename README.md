...
It is crucial that the chromosome names in the `info_file.csv` match those in `genome.fa` (e.g. _chrY_ and _>chrY_, rather than _Y_ and _>chrY_ or vice-versa). 
